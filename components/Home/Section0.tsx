export default function Section0() {
  return (
    <section className="relative isolate transform-gpu pt-14">
      ...
      <svg
        className="absolute inset-0 -z-10 size-full stroke-white/5 [mask-image:radial-gradient(75%_50%_at_top_center,white,transparent)]"
        aria-hidden="true"
      >
        <defs>
          <pattern
          ...
          >
            ...
            <div className="relative" style={{ transform: "none" }}>
              <div className="absolute -top-px right-20 h-2 w-20 [mask-image:linear-gradient(to_right,rgba(217,217,217,0)_0%,#d9d9d9_25%,#d9d9d9_75%,rgba(217,217,217,0)_100%)] md:w-32 lg:w-64">
                <div className="animate-starlight-right h-px w-full bg-gradient-to-r from-cyan-400/0 via-cyan-400 to-cyan-400/0"></div>
              </div>
              <div className="rounded-md bg-zinc-950 ring-1 ring-white/10 lg:rounded-2xl">
                <div className="" style={{ opacity: 1 }}>
                  <img
                    ...
                    srcSet="/_next/image?url=%2F_static%2Fdashboard.png&amp;w=256&amp;q=75 256w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=384&amp;q=75 384w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=640&amp;q=75 640w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=750&amp;q=75 750w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=828&amp;q=75 828w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=1080&amp;q=75 1080w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=1200&amp;q=75 1200w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=1920&amp;q=75 1920w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=2048&amp;q=75 2048w, /_next/image?url=%2F_static%2Fdashboard.png&amp;w=3840&amp;q=75 3840w"
                    src="/_next/image?url=%2F_static%2Fdashboard.png&amp;w=3840&amp;q=75"
                  />
                </div>
              </div>

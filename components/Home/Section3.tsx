    ...
    <section className="mx-auto max-w-7xl p-6 py-16 md:py-24 lg:px-8">
      <div className="grid max-w-xl items-start justify-between gap-5">
        ...
        <div className="text-lg text-zinc-400/80">
          ...
          figures and{" "}
          <span className="text-zinc-200">illuminate key trends</span> in your
          business.
        </div>
      </div>
      <div className="mt-16 grid gap-4 lg:grid-cols-2 lg:gap-6 xl:gap-8">
        <div className="col-span-full flex h-[480px] flex-col overflow-hidden rounded-2xl bg-zinc-900/50 ring-1 ring-zinc-100/10 lg:col-span-1">
          <div className="relative flex size-full items-center justify-center overflow-hidden px-3 pt-3">
            <div className="relative size-full rounded-xl [mask:radial-gradient(65%_65%_at_50%_40%,rgba(0,0,0,0.9)_35%,rgba(0,0,0,0)_100%)]">
              ...
              <div className="absolute left-0 top-0 size-full min-w-[1024px] opacity-20 [mask:linear-gradient(black,transparent)]">
                ...
                <div className="absolute top-16 px-2 text-xs/4">
                  <div className="flex flex-row items-center gap-2 rounded-md bg-zinc-800 px-2 py-1.5 ring-1 ring-zinc-400/20">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="max-w-48 text-zinc-400">
        ...
        <div className="col-span-full flex h-[480px] flex-col overflow-hidden rounded-2xl bg-zinc-900/50 ring-1 ring-zinc-100/10 lg:col-span-1">
          <div className="relative flex size-full transform-gpu items-center justify-center overflow-hidden">
            <div className="absolute inset-0 size-full [mask:radial-gradient(50%_50%_at_50%,rgba(0,0,0,0.7)_35%,rgba(0,0,0,0)_100%)]">
              <div className="absolute inset-0 -z-10 size-full text-zinc-300/10 [mask:linear-gradient(black,black_60%,transparent)]">
            ...
            <div className="relative flex size-full flex-col items-center justify-end px-4 pb-12 sm:px-8 lg:pb-16">
              ...
              <div className="mt-20 flex w-full items-center justify-between rounded-md bg-zinc-900 px-3 py-2 shadow-md ring-1 ring-zinc-200/10">
                ...
                <button className="relative inline-flex shrink-0 text-sm font-medium text-zinc-200">
                  <span className="z-10 inline-flex size-full items-center justify-center rounded-md bg-zinc-950 px-3 py-1.5 ring-1 ring-zinc-400/10 transition hover:ring-zinc-400/40 max-md:hidden">
                    Ask Genius
                  </span>
                  <span className="z-10 inline-flex size-full items-center justify-center rounded-md bg-zinc-950 px-2 py-1.5 ring-1 ring-zinc-400/10 transition hover:ring-zinc-400/40 md:hidden">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
                  ...
                  <span
                    className="absolute size-full blur-[1rem] motion-safe:animate-pulse"
                    style={{
                      background:

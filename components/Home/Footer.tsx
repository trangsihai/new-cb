      ...
      <div className="border-t border-white/10 pt-4 md:flex md:items-center md:justify-between">
        <div className="flex justify-center space-x-6 md:order-2">
          <a
            ...
            className="group flex size-6 items-center justify-center text-zinc-400 transition hover:text-zinc-300"
          ...
          <a
            ...
            className="group flex size-6 items-center justify-center text-zinc-400 transition-colors hover:text-zinc-300"
